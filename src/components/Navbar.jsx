  ...
  return (
    <div className="relative z-50">
      <nav className={`fixed top-0 w-full transition-all duration-300 ${
        isScrolled 
          ? 'backdrop-blur-xl bg-black/90 border-b border-yellow-400/20 shadow-2xl shadow-black/20' 
          ...
          <div className="flex justify-between items-center h-20">
            ...
            <div className="hidden md:flex items-center space-x-8">
              {['Inicio', 'Menú', 'Contacto'].map((item) => (
                <a 
                  key={item}
                  href="#" 
                  className="relative text-white/90 hover:text-yellow-300 transition-all duration-300 font-semibold text-lg group overflow-hidden"
                >
            ...
            <div className="flex items-center space-x-4">
              ...
              <button
                ...
                className="relative group bg-gradient-to-r from-yellow-400/20 to-orange-400/20 hover:from-yellow-400/30 hover:to-orange-400/30 backdrop-blur-sm border border-yellow-400/30 hover:border-yellow-400/50 px-4 py-3 rounded-xl transition-all duration-300 hover:scale-105 hover:shadow-lg hover:shadow-yellow-400/20"
              >
                <ShoppingCart className="h-6 w-6 text-yellow-300 group-hover:text-yellow-400 transition-colors duration-300" />
                {cartItems.length > 0 && (
                  <span className="absolute -top-2 -right-2 bg-gradient-to-r from-red-500 to-pink-500 text-white text-xs font-bold px-2 py-1 rounded-full animate-pulse shadow-lg">
              ...
              <button
                ...
                className="md:hidden bg-white/10 hover:bg-white/20 backdrop-blur-sm border border-white/20 hover:border-yellow-400/30 px-3 py-3 rounded-xl transition-all duration-300 hover:scale-105"
              >
                {mobileMenuOpen ? (
            ...
            <div className="pt-4 space-y-3">
              {['Inicio', 'Menú', 'Contacto'].map((item) => (
                <a 
                  key={item}
                  href="#" 
                  className="block text-white/90 hover:text-yellow-300 transition-all duration-300 font-semibold text-lg py-3 px-4 rounded-lg hover:bg-white/5 border-l-4 border-transparent hover:border-yellow-400"
